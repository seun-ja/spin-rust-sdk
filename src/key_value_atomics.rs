...
/// Increments the value of a key in the bucket.
pub fn atomics_increment(bucket: &Bucket, key: &str, value: i64) -> Result<i64, anyhow::Error> {
    Ok(atomics::increment(bucket, key, value)?)
}
...
impl keyvalue::atomics::Bucket {
    ...
    pub fn atomic_get(
        &self,
        key: &str,
        _ordering: Ordering, // Ideally an Ordering::Acquire,
    ...
    pub fn atomic_set(
        ...
        key: &str,
        value: &[u8],
        _ordering: Ordering, // Ideally an Ordering::Release,
    ) -> Result<(), anyhow::Error> {
    ...
    pub fn atomic_exists(
        &self,
        key: &str,
        _ordering: Ordering, // Ideally an Ordering::Relaxed,
